# IBM Data Science Capstone Project – SpaceX Launch Success Analysis

This repository contains all Jupyter notebooks and deliverables completed for the IBM Data Science Professional Certificate Capstone Project. The project analyzes SpaceX Falcon 9 launch data to identify trends and develop a predictive model for launch success.

## Repository Contents

### 1. Exploratory Data Analysis (EDA)
- SQL queries used to explore and summarize the dataset.
- Python-based data wrangling and visualization.
- Identification of trends across launch sites, booster versions, payload mass, and landing outcomes.

### 2. Interactive Map (Folium)
- Folium map created to visualize SpaceX launch site locations.
- Markers and circle markers added to represent site details and mission outcomes.
...
- Identify factors influencing launch success.
- Build machine learning models to predict mission outcomes.
